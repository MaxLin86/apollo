    ...
    for block in blocks:
        ...
        if block['type'] == 'net':
            ...
            if block.has_key('name'):
                ...
                conv_layer_name = 'conv%d' % layer_id
                bn_layer_name = 'conv%d-bn' % layer_id
                scale_layer_name = 'conv%d-scale' % layer_id

            if batch_normalize:
                try:
                    start = load_conv_bn2caffe(buf, start, params[conv_layer_name], params[bn_layer_name], params[scale_layer_name])
                    print(params[bn_layer_name])
                except:
                    print(block)
    ...
    for block in blocks:
        if block['type'] == 'net':
            ...
            if block.has_key('name'):
                ...
                conv_layer['top'] = 'conv%d' % layer_id
                conv_layer['name'] = 'conv%d' % layer_id
            ...
            if block['batch_normalize'] == '1':
                ...
                if block.has_key('name'):
                    ...
                    bn_layer['name'] = 'conv%d-bn' % layer_id
                bn_layer['type'] = 'BatchNorm'
                batch_norm_param = OrderedDict()
                batch_norm_param['eps']='1e-06'
                ...
                if block.has_key('name'):
                    ...
                    scale_layer['name'] = 'conv%d-scale' % layer_id
            ...
            if block['activation'] != 'linear':
                ...
                if block.has_key('name'):
                    ...
                    activate_layer['name'] = 'conv%d-act' % layer_id
            ...
            if block['activation'] != 'linear':
                ...
                if block.has_key('name'):
                    ...
                    relu_layer['name'] = 'conv%d-act' % layer_id
            ...
            if block.has_key('name'):
                ...
                max_layer['top'] = 'maxpool%d' % layer_id
                max_layer['name'] = 'maxpool%d' % layer_id
