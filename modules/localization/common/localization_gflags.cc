...
DEFINE_bool(ins_localization_valid, true, 
            "localization by gps and imu is valid, guidepost map is in world coordinate");

DEFINE_bool(guidepost_localization_valid, true,
        "localization by guidepost is valid, guidepost map can in world coordinate or local coordinate.");
