...
const CHAR* rdc_preset_descriptions[] =
{
    ...
    "VP104",   "SabineB - Highway-2, 1GHz Sampling Rate",
    "VP105",   "SabineB - City-1, 1GHz Sampling Rate",
    "VP211",   "SabineB - 1G chip rate scan",
    ...
    "CP210",   "SabineB - 1G chip rate scan",
    "VP114",   "SabineB - Like VP101 but fewer pings per PRI (11/15)",
};
