...
#include "modules/drivers/radar/quill_radar/driver/system-radar-software/engine/common/eng-api/irq-enums.h"
#if SABINE_B
#include "modules/drivers/radar/quill_radar/driver/system-radar-software/engine/scp-src/eng-api/pvt.h"
#endif
...
#endif //if WITH_DIAGS && WITH_CAL_DIAGS
#endif
...
{
#if SABINE_A
    { GIC_SPI_RSP_PGU_INT_0, EDGE_TRIGGERED, GIC_SCP_TARGET, &PGU_int0handler, SECURE },
    { GIC_SPI_RSP_PGU_INT_1, EDGE_TRIGGERED, GIC_SCP_TARGET, &PGU_int1handler, SECURE },
    { GIC_SPI_RSP_ICU_INT_0, EDGE_TRIGGERED, GIC_SCP_TARGET, &ICU_int0handler, SECURE },
#if WITH_DIAGS && WITH_CAL_DIAGS
    { GIC_SPI_RSP_ICU_INT_1, EDGE_TRIGGERED, GIC_SCP_TARGET, &ICUint1handler, SECURE },
#endif
