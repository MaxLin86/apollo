...
public:
    ...
    //! one microsecond.  This clock wraps around before 0xFFFFFFFFUL due
...
public:
    ...
    virtual void           set_ego_velocity_shift(
                                    ...
                                    RDC_Doppler_Shift_RDC_Mode     rdc_shift_mode,  //!<
...
public:
    ...
    virtual bool            request_peakdet(
                                    EventEnum                completion,    //!< Event ID to be posted when A-Probe measurement completes
                                    const RDC_PeakDetRequest& request        //!< A-Probe request descriptor
                                    ) = 0;
#endif
