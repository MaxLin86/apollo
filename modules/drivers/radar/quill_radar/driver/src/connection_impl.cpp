...
#include "modules/drivers/radar/quill_radar/driver/src/srs-profiling.h"
#include "modules/drivers/radar/quill_radar/driver/src/connection_impl.h"
#include "modules/drivers/radar/quill_radar/driver/src/scanning_impl.h"
#include "modules/drivers/radar/quill_radar/driver/src/scanobject_impl.h"
#include "modules/drivers/radar/quill_radar/driver/system-radar-software/engine/scp-src/diag/api/diag_calibrate_structs.h"

#include "modules/drivers/radar/quill_radar/driver/system-radar-software/env-uhnder/coredefs/uhstdlib.h"
...
#include "modules/drivers/radar/quill_radar/driver/system-radar-software/engine/scp-src/eng-api/state-manager.h"
...
#include "modules/drivers/radar/quill_radar/driver/include/vehiclecan.h"
...
#include "modules/drivers/radar/quill_radar/driver/src/uhdp/discovery-diag.h"
#include "modules/drivers/radar/quill_radar/driver/src/uhdp//discovery-logmsg.h"
#include "modules/drivers/radar/quill_radar/driver/src/uhdp//discovery-antcfg.h"
#include "modules/drivers/radar/quill_radar/driver/src/uhdp//discovery-ppa.h"
#include "modules/drivers/radar/quill_radar/driver/src/uhdp//logaggr.h"
...
void Connection_Impl::poll_socket_internal()
{
    ...
    if (diag_last_resend)
    {
        uint64_t timeout = UH_CLOCK_TICS_PER_SECOND * 5 * timeout_scale;
    ...
    for (;;)
    {
        ...
        if (uhdp->message_type == UHDP_TYPE_TIME_ALIGN)
        {
            ...
            else if (frame_interval_base_host_time.tv_sec &&
...
void            Connection_Impl::send_frame_interval_base_time()
{
    ...
    uint64_t t = (uint64_t)UH_CLOCK_TICS_PER_SECOND * frame_interval_base_host_time.tv_sec +
                 (uint64_t)UH_CLOCK_TICS_PER_MICRO_SECONDS * frame_interval_base_host_time.tv_usec;
...
class Connection*   make_connection(uint32_t radar_ip, uint32_t timeout_sec, UserLogAgent& log_agent, bool use_thread)
{
    ...
    // SWE-3788: The radar capture protocol needs to know if the module is
    // sabineA or sabineB in order to interpret the 32bit clock when it wraps
    // around. If we do not know whether we are sabineA or sabineB, we have to
    // query the radar status bits.  If this is triggered when the API thread is
    // already in a blocking call (wait_for_scan(), etc) then a deadlock can
    // happen.
    (void)con->query_radar_status_bitmask();
