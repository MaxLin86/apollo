...
#include "modules/drivers/radar/quill_radar/driver/system-radar-software/engine/common/eng-api/rdc-structs.h" //PointCloudData
...
const PointCloudData* PointCloud_Impl::get_raw_points()
{
    collect_clutter_points();
