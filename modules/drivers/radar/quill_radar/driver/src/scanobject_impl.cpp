...
#include "modules/drivers/radar/quill_radar/driver/src/detections_impl.h"
#include "modules/drivers/radar/quill_radar/driver/src/staticslice_impl.h"
#include "modules/drivers/radar/quill_radar/driver/src/zerodoppler_impl.h"
#include "modules/drivers/radar/quill_radar/driver/src/activations_impl.h"
#include "modules/drivers/radar/quill_radar/driver/src/musicdata_impl.h"
#include "modules/drivers/radar/quill_radar/driver/src/radardatacube1_impl.h"
#include "modules/drivers/radar/quill_radar/driver/src/adccapturedata_impl.h"
#include "modules/drivers/radar/quill_radar/driver/src/pointcloud_impl.h"
...
ScanObject* ScanObject::deserialize(ScanSerializer& s, uint32_t scan_sequence_number)
{
    ...
    if (len)
    {
        ...
        bool ok = scan->deserialize_scan_info_bin(s, len);
...
bool ScanObject_Impl::deserialize_scan_info_bin(ScanSerializer& s, size_t bytes)
{
    bool ok = true;
    ok &= s.read_scan_data_type(&scan_info, sizeof(scan_info), 1);
    ok &= s.read_scan_data_type(&mythresh, sizeof(mythresh), 1);
    ok &= s.read_scan_data_type(&host_local_time, sizeof(host_local_time), 1);
...
bool ScanObject_Impl::serialize_scan_info_bin(ScanSerializer& s) const
{
    ...
    ok &= s.write_scan_data_type(&host_local_time, sizeof(host_local_time), 1);
