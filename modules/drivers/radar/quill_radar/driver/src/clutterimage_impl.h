...
#include "modules/drivers/radar/quill_radar/driver/include/clutterimage.h"
...
public:
    ...
    virtual uint32_t get_point_cloud_points(PointCloudData* buffer, uint32_t buffer_size_points);
