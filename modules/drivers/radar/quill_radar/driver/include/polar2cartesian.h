...
public:
    ...
    struct SubSpace
    {
        ...
        int32_t  center_Y; //!< the center Y bin to be updated (-DIM_Y/2..DIM_Y/2)
        int32_t  center_Z; //!< the center Z bin to be updated (-DIM_Z/2..DIM_Z/2)
     ...
     * predefined pixel/voxel space to process. If the SubSpace does not fit
    ...
    static void estimate_bounds_scan_object(BoundsInfo&,
                                            const ScanObject&,
                                            bool  wrap_azimuth_ambiguity,
                                            bool  wrap_elevation_ambiguity);

    
    static void estimate_bounds_process(BoundsInfo& b,
