...
#include "modules/drivers/radar/uhnder_radar/driver/system-radar-software/engine/common/eng-api/rdc-internals.h"
...
bool     ClutterImage_Impl::post_process()
{
    ...
    // force-zero the top-left corner - almost always unused. Polar2Cartesian
    // uses this sample to represent the background
    mag_plane[(R - 1) * AZ * EL] = 0;
