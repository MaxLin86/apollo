...
public:
    ...
    virtual const UhdpThresholdControl* get_scan_thresholds() const = 0;
    ...
    //! might return NULL if no ADC data was captured for this scan
    virtual const cint8*               get_adc_samples(uint32_t& count, bool& interleaved) const = 0;
    ...
    virtual const RHAL_Histogram*      get_histogram(uint32_t range_bin) const = 0;
