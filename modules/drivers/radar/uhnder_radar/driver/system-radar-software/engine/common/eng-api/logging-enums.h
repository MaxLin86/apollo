...
/*! Each log producer can interally define MAX_LOG_SUBUNITS sub-units which can
 * be individually configured with a log level filter. The definitions of
 * these sub-units are private (between the log producer and the consumer) */
enum { MAX_LOG_SUBUNITS = 36 };
...
#include "modules/drivers/radar/uhnder_radar/driver/system-radar-software/engine/common/eng-api/engine-messagedef.inc"
#include "modules/drivers/radar/uhnder_radar/driver/system-radar-software/env-uhnder/coredefs/environment-messagedef.inc"
    NUM_MESSAGE_ENUMS
};
...
#include "modules/drivers/radar/uhnder_radar/driver/system-radar-software/engine/common/eng-api/engine-taskdef.inc"
#include "modules/drivers/radar/uhnder_radar/driver/system-radar-software/env-uhnder/coredefs/environment-taskdef.inc"
#undef DEFINE_TASK
    NUM_TASK_ENUMS
};
