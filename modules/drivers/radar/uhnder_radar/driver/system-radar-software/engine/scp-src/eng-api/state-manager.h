...
enum SystemStateAttributes
{
    ...
    /*! Scans are running, an RDC_ScanConfig is actively scanning. This flag is
     * not cleared when scans are paused, scanning is considered to still be
     * active. The flag is cleared when the RDC_ScanConfig has been completely
