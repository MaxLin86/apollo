...
namespace RRA
{
#include "modules/drivers/radar/rocket_radar/driver/src/rra-revdesc.h" // machine generated header in build folder
}

namespace SRS
{
#include "modules/drivers/radar/rocket_radar/driver/system-radar-software/engine/common/eng-api/srs-revdesc.h" // machine generated header in build folder
}
