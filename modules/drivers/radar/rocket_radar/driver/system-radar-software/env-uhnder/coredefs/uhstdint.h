...
/* Mar 13th, 2020 -> contains the macros above */
#include <inttypes.h>

/* these macros will only be set with a certain compiler flags */
#if !defined(PRIi64)
    #error  "[uhstdint.h] - Greenhills - please set --c++11 and --stdl"
#endif
