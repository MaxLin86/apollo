...
#define TCMB_START_ADDRESS_SYS_VIEW   0x21020000
// Reserve bytes from end of TCMB for persistent modulecfg
#define TCMB_END_RESERVED_SIZE        512
#define TCMB_END_RESERVED_ADDRESS     (TCMB_START_ADDRESS + TCMB_SIZE - TCMB_END_RESERVED_SIZE - TCMB_SCP_STACK_SIZE)

#define TCMB_END_RESERVED_ADDRESS_SYS_VIEW (TCMB_END_RESERVED_ADDRESS +TCMB_START_ADDRESS_SYS_VIEW)
