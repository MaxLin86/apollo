 ...
 * @LastEditTime: 2020-05-07 19:00:00
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /apollo-5.5.0/modules/monitor/monitor.cc
 */
/******************************************************************************
...
bool Monitor::Init() {
  ...
  AERROR<<"Monitor::Init";
  monitor::common::monitor_can::mc()->init();
  ...
  // runners_.emplace_back(new VcuMonitor());
  // runners_.emplace_back(new ErrorMonitor());
  runners_.emplace_back(new SocketMonitor());
...
bool Monitor::Proc() {
  ...
  AERROR<<"Monitor::Proc:current_time"<<current_time;
