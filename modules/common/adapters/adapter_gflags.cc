...
DEFINE_string(aeb_command_topic, "/apollo/urgency",
              "aeb control topic.");

DEFINE_string(manuctrl_topic, "/apollo/manuctrl",
              "serial command topic.");

DEFINE_string(ultra_radar_topic, "/apollo/sensor/radar/stop",
              "ultra radar topic.");

DEFINE_string(tmc_topic, "/apollo/tmc",
              "tmc topic.");
