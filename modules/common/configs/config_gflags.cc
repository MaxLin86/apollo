...
//add by shzhw
DEFINE_bool(use_sim_chassis, false, "Enable publish sim chassis.");
DEFINE_bool(use_sim_localization, false, "Enable publish sim localization.");
DEFINE_bool(use_sim_prediction, false, "Enable publish sim prediction.");

DEFINE_bool(enable_radar_write_localization_msg, false, 
              "Enable radar module write virtual localization messages");
//-----------------------------------------------------
