//
//
#ifndef HOBOT_ADAS_UTILS_KALMAN_FILTER_SELF_CAR_LOCALIZATION_H_
#define HOBOT_ADAS_UTILS_KALMAN_FILTER_SELF_CAR_LOCALIZATION_H_
...
class SelfCarLocalizationEKF : public ExtendedKalmanFilter {
 public:
  explicit SelfCarLocalizationEKF(int kf_coor_sys = 1);
  virtual ~SelfCarLocalizationEKF();
...
#endif  // HOBOT_ADAS_UTILS_KALMAN_FILTER_SELF_CAR_LOCALIZATION_H_
