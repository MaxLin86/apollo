...
bool RelativeMapComponent::InitReaders() {
  ...
  //tcs_navigatior_writer_ = node_->CreateWriter<NavigationInfo>(FLAGS_tcs_navigation_topic);//33333333333
  tcs_navigatior_writer_ = node_->CreateWriter<NavigationInfo>(FLAGS_navigation_topic);//33333333333
  return true;
}
