...
class NavigationLane {
 public:
  ...
  void SetLaneMarkerMissCount(const int lane_marker_miss_count) {
    lane_marker_miss_count_ = lane_marker_miss_count;
  }
  // 20201020
  void SetLaneMarkerValid(const bool is_lane_marker_valid) {
    is_lane_marker_valid_ = is_lane_marker_valid;
  }

  bool GetLaneMarkerValid() {
    return is_lane_marker_valid_;
  }

  void UpdateGuidepostMarker(
      const perception::LaneMarker& perception_guidepost_marker) {
    perception_guidepost_marker_ = perception_guidepost_marker;
  }
 ...
 private:
   ...
   * @return None.
   */
  bool ConvertLaneMarkerToPath(const perception::LaneMarkers& lane_marker,
 ...
 private:
  ...
  int lane_marker_miss_count_;
  
  bool is_lane_marker_valid_;

  // received from topic: /apollo/routing_response(already trans lanemarker) shzhw
  perception::LaneMarker perception_guidepost_marker_;
