...
//add by shzhw
DECLARE_double(obstacle_lon_distance_threshold_to_stop);
DECLARE_double(obstacle_lat_distance_threshold_to_stop);
DECLARE_uint32(not_detect_obstacle_count_threshold);
DECLARE_double(default_obstacle_ref_vx);

DECLARE_bool(enable_create_virtual_obstalce);
DECLARE_double(virtual_obstacle_range);
DECLARE_bool(enable_guidepost_cruise);
DECLARE_bool(using_lanepoint_guide);
DECLARE_double(lanepoint_tartget_px);
...
DECLARE_double(vehicle_start_px);
DECLARE_double(vehicle_start_py);
DECLARE_double(vehicle_start_phi);
