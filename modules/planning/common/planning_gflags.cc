...
DEFINE_double(default_cruise_speed, 1.3, "default cruise speed");
...
//add by shzhw
DEFINE_double(obstacle_lon_distance_threshold_to_stop, 30.0,
                "the maximum of obstacle longitudinal distance for stop");
DEFINE_double(obstacle_lat_distance_threshold_to_stop, 1.0,
                "the maximum of obstacle lateral distance for stop");
DEFINE_uint32(not_detect_obstacle_count_threshold, 30,
                "the min of not detect obstacle count");
DEFINE_double(default_obstacle_ref_vx, 5.0, 
                "the nearest obstalce linear velocity ref ego");

DEFINE_bool(enable_create_virtual_obstalce, true,
                "enable create a virtual obstacle, just for test");
DEFINE_double(virtual_obstacle_range, 50,
                "the range of virtual obstacle, just for test");

DEFINE_bool(enable_guidepost_cruise,true, "enabel cruise using guidepost");
DEFINE_bool(using_lanepoint_guide, true, "using lane line middle point as guidepost");
DEFINE_double(lanepoint_tartget_px, 5.0, "the target point px using lane line as guidepost");
...
DEFINE_double(vehicle_start_px, 30.0, "the start point px");
DEFINE_double(vehicle_start_py, -15.0, "the start point py");
DEFINE_double(vehicle_start_phi, 1.5708, "the start point phi");
