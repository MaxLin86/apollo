...
class Frame {
 public:
  ...
  //add by shzhw
  uint32_t NullCollisionObstacleCycs() const;
  bool NullCollisionObstacle() const;
  //----------------------------------------
 ...
 private:
  ...
  //add by shzhw
  static uint32_t null_collision_obstacle_cycs_;
 static bool null_collision_obstacle_;
  //-----------------------
