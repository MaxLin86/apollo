...
#include "modules/planning/tracking_object.h" //20200628
...
class PlanningComponent final
 ...
 private:
  ...
  std::vector<GuidepostGroup> guidepostGroupVector; //add by shzhw
  std::unique_ptr<TrackingSelfCarObject> tracking_selfcar_;
  std::vector<std::vector<Vec2d>>  yard_obstacles_list_;
