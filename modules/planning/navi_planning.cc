...
void NaviPlanning::RunOnce(const LocalView& local_view,
  ...
  //add by shzhw to invalid vehicle config (no localization)
  vehicle_config.x_ = 0.0;
  vehicle_config.y_ = 0.0;
  vehicle_config.theta_ = 0.0;
  vehicle_config.is_valid_ = false;
  //------------------------------------
