...
//--------------------------------------------------------------
DEFINE_bool(control_enable_drive_len_test, true, "enable drive length test in control modules");
DEFINE_double(drive_len_test_throttle, 11, "drive len test throttle");
DEFINE_double(control_test_drive_length, 0.05, "test drive length in control module");
