...
const std::map<ObjectSubType, ObjectType> kSubType2TypeMap = {
    ...
    {ObjectSubType::PERSON, ObjectType::VEHICLE},
    {ObjectSubType::CAR, ObjectType::VEHICLE},
    {ObjectSubType::CONETANK, ObjectType::VEHICLE},
    {ObjectSubType::CARRIAGE, ObjectType::VEHICLE},
    // {ObjectSubType::CAR, ObjectType::VEHICLE},
...
const std::map<ObjectSubType, std::string> kSubType2NameMap = {
    ...
    {ObjectSubType::PERSON, "PERSON"},
    {ObjectSubType::CAR, "CAR"},
    {ObjectSubType::CONETANK, "CONETANK"},
    {ObjectSubType::CARRIAGE, "CARRIAGE"},
    // {ObjectSubType::CAR, "CAR"},
...
const std::map<std::string, ObjectSubType> kName2SubTypeMap = {
    ...
    {"PERSON", ObjectSubType::PERSON},
    {"CAR", ObjectSubType::CAR},
    {"CONETANK", ObjectSubType::CONETANK},
    {"CARRIAGE", ObjectSubType::CARRIAGE},
    // {"CAR", ObjectSubType::CAR},
